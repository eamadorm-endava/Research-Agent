...
class ToolUsageRecord(BaseModel):
    ...
    final_time: Annotated[
        datetime,
        Field(description="Timestamp indicating when the tool completed execution"),
    ]
    tool_full_time: Annotated[
        float, Field(description="Total duration of the tool execution in seconds")
    ]
...
class MetricsRecord(BaseModel):
    ...
    time_to_answer: Annotated[
        float, Field(description="Total time taken to process the turn in seconds")
    ]
