...
This directory contains Architecture Decision Records (ADRs) for the Gemini Enterprise AI Agents and Services project. ADRs are short documents that capture important architectural decisions, the context behind them, and their consequences.
