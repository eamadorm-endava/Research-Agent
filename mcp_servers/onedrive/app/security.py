...
def create_onedrive_client() -> OneDriveClient:
    """
    Factory to create a OneDriveClient using the current authenticated token.
    ...
    Returns:
        OneDriveClient -> An initialized client ready to interact with Graph API.
    """
