...
class GCSManager:
    ...
    def update_bucket_labels(self, bucket_name: str, labels: Dict[str, str]) -> Dict[str, str]:
        """
    ...
    def create_object(
        ...
        try:
            ...
            if local_path:
                ...
                logger.info(f"File {local_path} uploaded as {object_name} to bucket {bucket_name}.")
            ...
            logger.error(f"Error creating object {object_name} in bucket {bucket_name}: {e}")
            raise
    ...
    def update_object_metadata(self, bucket_name: str, object_name: str, metadata: Dict[str, Any]) -> storage.Blob:
        """
